...
public class Note_List_Adapter extends BaseAdapter {
    private Button btn_search,menu;
    private ArrayList<Content> title_list;
    private Activity context;
    public Note_List_Adapter(Activity context, ArrayList<Content> lists) {
this.context=context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View v = view.inflate(viewGroup.getContext(), R.layout.activity_list_note,null);
        ImageView img=v.findViewById(R.id.list_img);
        TextView txt = v.findViewById(R.id.notes_title);

...
public class video_list_adapter extends BaseAdapter {
    ...
    public video_list_adapter(Activity context, ArrayList<Content> lists) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View v = view.inflate(viewGroup.getContext(), R.layout.activity_video_row,null);
        v.callOnClick();
        ImageView img=v.findViewById(R.id.list_img);
        TextView txt = v.findViewById(R.id.video_title);
        String testtitle=title_list.get(i).getTitle();
